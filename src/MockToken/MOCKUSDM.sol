...
contract MOCKUSDM is ERC20 {
    /**
     * @notice Constructs a new mock USDm token
     * @dev Initializes with name "USDm" and symbol "USDm"
     */
    constructor() ERC20("MegaUSD", "USDm") { }

    /**
     * @notice Returns the number of decimals used for the token
     * @return Number of decimal places (6 for USDm)
     */
