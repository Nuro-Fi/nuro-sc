...
/**
 * @title MOCKEURC
 * @notice Mock Euro Coin token for testing purposes on Arc Testnet
 * @dev Extends OpenZeppelin's ERC20 with 6 decimals and public mint/burn functions
 */
contract MOCKEURC is ERC20 {
    /**
     * @notice Constructs a new mock EURC token
     * @dev Initializes with name "Euro Coin" and symbol "EURC"
     */
    constructor() ERC20("Euro Coin", "EURC") { }

    /**
     * @notice Returns the number of decimals used for the token
     * @return Number of decimal places (6 for EURC)
     */
