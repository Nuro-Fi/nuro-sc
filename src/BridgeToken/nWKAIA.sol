 ...
 */
contract nWKAIA is Initializable, ContextUpgradeable, ERC20Upgradeable, PausableUpgradeable, UUPSUpgradeable, AccessControlUpgradeable {
    // =============================================================
    //                           CONSTANTS
    // =============================================================
    ...
    /**
     * @notice Initializes the nWKAIA token contract
     * @dev Initializes with name "Wrapped KAIA representative" and symbol "nWKAIA"
     */
    constructor() {
    ...
    function initialize() public initializer {
        __ERC20_init("Wrapped KAIA representative", "nWKAIA");
