 ...
 */
contract NTOKEN is Initializable, ContextUpgradeable, ERC20Upgradeable, PausableUpgradeable, UUPSUpgradeable, AccessControlUpgradeable {
    // =============================================================
    //                           CONSTANTS
    // =============================================================
    ...
    /// @dev keccak256(abi.encode(uint256(keccak256("nuro.storage.STOKEN")) - 1)) & ~bytes32(uint256(0xff))
    ...
    /// @custom:storage-location erc7201:nuro.storage.STOKEN
