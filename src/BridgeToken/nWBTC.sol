 ...
 */
contract nWBTC is Initializable, ContextUpgradeable, ERC20Upgradeable, PausableUpgradeable, UUPSUpgradeable, AccessControlUpgradeable {
    // =============================================================
    //                           CONSTANTS
    // =============================================================
    ...
    /**
     * @notice Initializes the nWBTC token contract
     * @dev Initializes with name "Wrapped BTC representative" and symbol "nWBTC"
     */
    constructor() {
    ...
    function initialize() public initializer {
        __ERC20_init("Wrapped BTC representative", "nWBTC");
