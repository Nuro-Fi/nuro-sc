 ...
 */
contract nKAIA is Initializable, ContextUpgradeable, ERC20Upgradeable, PausableUpgradeable, UUPSUpgradeable, AccessControlUpgradeable {
    // =============================================================
    //                           CONSTANTS
    // =============================================================
    ...
    /**
     * @notice Initializes the nKAIA token contract
     * @dev Initializes with name "KAIA representative backed by Nuro" and symbol "nKAIA"
     */
    constructor() {
    ...
    function initialize() public initializer {
        __ERC20_init("KAIA representative backed by Nuro", "nKAIA");
