 ...
 */
contract nUSDT is Initializable, ContextUpgradeable, ERC20Upgradeable, PausableUpgradeable, UUPSUpgradeable, AccessControlUpgradeable {
    // =============================================================
    //                           CONSTANTS
    // =============================================================
    ...
    /**
     * @notice Initializes the nUSDT token contract
     * @dev Initializes with name "USD Tether representative" and symbol "nUSDT"
     */
    constructor() {
    ...
    function initialize() public initializer {
        __ERC20_init("USD Tether representative", "nUSDT");
