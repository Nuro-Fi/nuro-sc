...
/**
 * @title nEURC
 * @notice Synthetic EURC token representing EURC deposits locked on Arc in the Nuro protocol
 * @dev ERC20 token with operator-controlled minting and burning, 6 decimals to match EURC
 *      Deployed on spoke chains (Base, Arbitrum) - minted when EURC locked on Arc
 */
contract nEURC is Initializable, ContextUpgradeable, ERC20Upgradeable, PausableUpgradeable, UUPSUpgradeable, AccessControlUpgradeable {
    // =============================================================
    //                           CONSTANTS
    // =============================================================
    ...
    /**
     * @notice Initializes the nEURC token contract
    ...
    function initialize() public initializer {
        __ERC20_init("Euro Coin representative", "nEURC");
