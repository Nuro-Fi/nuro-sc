 ...
 */
contract nWETH is Initializable, ContextUpgradeable, ERC20Upgradeable, PausableUpgradeable, UUPSUpgradeable, AccessControlUpgradeable {
    // =============================================================
    //                           CONSTANTS
    // =============================================================
    ...
    /**
     * @notice Initializes the nWETH token contract
     * @dev Initializes with name "Wrapped ETH representative" and symbol "nWETH"
     */
    constructor() {
    ...
    function initialize() public initializer {
        __ERC20_init("Wrapped ETH representative", "nWETH");
