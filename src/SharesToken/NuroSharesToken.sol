...
/**
 * @title NuroSharesToken
 * @notice SharesToken token representing deposits in the Nuro protocol
 * @dev ERC20 token with operator-controlled minting and burning, fixed 18 decimals
 */
contract NuroSharesToken is Initializable, ContextUpgradeable, ERC20Upgradeable, PausableUpgradeable, UUPSUpgradeable, AccessControlUpgradeable {
    // =============================================================
    //                           CONSTANTS
    // =============================================================
    ...
    /**
     * @notice Initializes the NuroSharesToken token contract
    ...
    {
        __ERC20_init(
            string.concat("Nuro ", _name, " Token - ", Strings.toString(_date)), string.concat("Nuro", _symbol, "-", Strings.toString(_date))
        );
