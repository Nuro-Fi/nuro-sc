...
/**
 * @title NuroUSDT
 * @notice Synthetic USDT token representing USDT deposits in the Nuro protocol
 * @dev ERC20 token with operator-controlled minting and burning, fixed 6 decimals to match USDT
 */
contract NuroUSDT is Initializable, ContextUpgradeable, ERC20Upgradeable, PausableUpgradeable, UUPSUpgradeable, AccessControlUpgradeable {
    // =============================================================
    //                           CONSTANTS
    // =============================================================
    ...
    /**
     * @notice Initializes the NuroUSDT token contract
    ...
    function initialize(string memory _date) public initializer {
        __ERC20_init(string.concat("NuroUSDT-", _date), string.concat("NuroUSDT-", _date));
     ...
     * @return Always returns 6 decimals to match USDT standard
     */
