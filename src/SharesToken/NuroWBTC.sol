...
/**
 * @title NuroWBTC
 * @notice Synthetic Wrapped BTC token representing WBTC deposits in the Nuro protocol
 * @dev ERC20 token with operator-controlled minting and burning, fixed 8 decimals to match Bitcoin
 */
contract NuroWBTC is Initializable, ContextUpgradeable, ERC20Upgradeable, PausableUpgradeable, UUPSUpgradeable, AccessControlUpgradeable {
    // =============================================================
    //                           CONSTANTS
    // =============================================================
    ...
    /**
     * @notice Initializes the NuroWBTC token contract
    ...
    function initialize(string memory _date) public initializer {
        __ERC20_init(string.concat("NuroWBTC-", _date), string.concat("NuroWBTC-", _date));
     ...
     * @return Always returns 8 decimals to match Bitcoin standard
     */
