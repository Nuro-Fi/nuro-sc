...
/**
 * @title NuroEURC
 * @notice Shares token representing EURC deposits in Nuro lending pools on Arc
 * @dev ERC20 token with operator-controlled minting and burning, 6 decimals to match EURC
 */
contract NuroEURC is Initializable, ContextUpgradeable, ERC20Upgradeable, PausableUpgradeable, UUPSUpgradeable, AccessControlUpgradeable {
    // =============================================================
    //                           CONSTANTS
    // =============================================================
    ...
    /**
     * @notice Initializes the NuroEURC token contract
    ...
    function initialize(string memory _date) public initializer {
        __ERC20_init(string.concat("NuroEURC-", _date), string.concat("NuroEURC-", _date));
     ...
     * @return Always returns 6 decimals to match EURC standard
     */
