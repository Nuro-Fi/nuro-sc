...
/**
 * @title NuroKAIA
 * @notice Synthetic KAIA token representing KAIA deposits in the Nuro protocol
 * @dev ERC20 token with operator-controlled minting and burning, fixed 18 decimals
 */
contract NuroKAIA is Initializable, ContextUpgradeable, ERC20Upgradeable, PausableUpgradeable, UUPSUpgradeable, AccessControlUpgradeable {
    // =============================================================
    //                           CONSTANTS
    // =============================================================
    ...
    /**
     * @notice Initializes the NuroKAIA token contract
    ...
    function initialize(string memory _date) public initializer {
        __ERC20_init(string.concat("NuroKAIA-", _date), string.concat("NuroKAIA-", _date));
