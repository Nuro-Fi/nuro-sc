...
/**
 * @title NuroWKAIA
 * @notice Synthetic Wrapped KAIA token representing WKAIA deposits in the Nuro protocol
 * @dev ERC20 token with operator-controlled minting and burning, fixed 18 decimals
 */
contract NuroWKAIA is Initializable, ContextUpgradeable, ERC20Upgradeable, PausableUpgradeable, UUPSUpgradeable, AccessControlUpgradeable {
    // =============================================================
    //                           CONSTANTS
    // =============================================================
    ...
    /**
     * @notice Initializes the NuroWKAIA token contract
    ...
    function initialize(string memory _date) public initializer {
        __ERC20_init(string.concat("NuroWKAIA-", _date), string.concat("NuroWKAIA-", _date));
