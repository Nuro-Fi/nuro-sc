    ...
    LendingPoolFactoryHook
{
    ...
    /// @notice The address of the NuroEmitter contract
    address public nuroEmitter;
        ...
        returns (address)
    {
        ...
        INuroEmitter(nuroEmitter).sharesTokenDeployed(router, ILPRouter(router).sharesToken()); // TODO: Delete this line
        ...
        INuroEmitter(nuroEmitter).grantRole(keccak256("ADMIN_ROLE"), lendingPool);
    ...
    /**
     * @notice Sets the Nuro emitter contract address
     * @dev Only callable by addresses with OWNER_ROLE
     * @param _nuroEmitter The address of the Nuro emitter contract
     */
    function setNuroEmitter(address _nuroEmitter) public onlyRole(OWNER_ROLE) {
        nuroEmitter = _nuroEmitter;
        emit NuroEmitterSet(_nuroEmitter);
    }
