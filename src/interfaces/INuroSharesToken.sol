...
/**
 * @title INuroSharesToken
 * @notice Interface for the NuroSharesToken contract
 * @dev This interface defines the public functions for managing shares tokens in the Nuro protocol
 */
interface INuroSharesToken is IERC20 {
    // =============================================================
    //                           EVENTS
    // =============================================================
