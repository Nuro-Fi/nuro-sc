...
interface IFactory {
    ...
    /**
     * @notice Returns the address of the nuro emitter contract
     * @return Address of the nuro emitter contract
     */
    function nuroEmitter() external view returns (address);
    ...
    /**
     * @notice Sets the NuroEmitter contract address
     * @param _nuroEmitter Address of the NuroEmitter contract
     */
    function setNuroEmitter(address _nuroEmitter) external;
}
