...
abstract contract LendingPoolFactoryHook {
    ...
    /**
     * @notice Emitted when the NuroEmitter address is set
     * @param nuroEmitter The address of the NuroEmitter contract
     */
    event NuroEmitterSet(address indexed nuroEmitter);
