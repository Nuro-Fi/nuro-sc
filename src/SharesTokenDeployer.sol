...
contract SharesTokenDeployer is Ownable {
    ...
    NuroSharesToken public nuroSharesToken;
    ...
    function deploySharesToken() public returns (address) {
        nuroSharesToken = new NuroSharesToken();
        emit DeployedSharesToken(address(nuroSharesToken));
        return address(nuroSharesToken);
    }
