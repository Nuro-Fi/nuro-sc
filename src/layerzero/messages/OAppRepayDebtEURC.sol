...
import { RepayParams } from "../../lib/LendingPoolHook.sol";

/**
 * @title OAppRepayDebtEURC
 ...
 */
contract OAppRepayDebtEURC is OApp, OAppOptionsType3 {
    ...
    /**
     * @notice Constructs the OAppRepayDebtEURC contract
    ...
    function execute(address _lendingPool, address _user, uint256 _amount) public {
        ...
        ILendingPool(_lendingPool)
            .repayWithSelectedToken(
                RepayParams({ user: _user, token: borrowToken, shares: _amount, amountOutMinimum: 500, fromPosition: false, fee: 1000 })
            );
