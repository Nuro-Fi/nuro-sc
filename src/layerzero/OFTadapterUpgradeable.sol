...
contract OFTadapterUpgradeable is OFTAdapterUpgradeable, ReentrancyGuard, ChainSettlement {
    ...
    /// @custom:storage-location erc7201:nuro.storage.NuroOFTAdapterUpgradeable
    ...
    // keccak256(abi.encode(uint256(keccak256("nuro.storage.NuroOFTAdapterUpgradeable")) - 1)) & ~bytes32(uint256(0xff))
